const gameData = {
    ...
    forest: {
        text: "You enter the forest and encounter a wise old man. Do you ask for a forest route or a map?",
        choices: [{ text: "Ask for a Forest Route", consequence: "forestroute" }, { text: "Ask for a Map", consequence: "forestMap" }],
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIyy67hOJOaNPiMNnL0dmOUsL9RGzrnltdew&s"
    },
    mountains: {
